...
public class Quote {
     ...
     * {@link #AMONT_OF_MONTHY_INSTALLMENTS} payments have been made.
     * <p>
    ...
    private double calculateMonthlyInstallment() {
        ...
        double exponentiation = Math.pow(1 + i, AMONT_OF_MONTHY_INSTALLMENTS);
     ...
     * times the {@link #AMONT_OF_MONTHY_INSTALLMENTS}.
     * <p>
    ...
    public String getTotalRepayment() {
        ...
        double roundedValue = Double.parseDouble(getMonthlyInstallment()) * AMONT_OF_MONTHY_INSTALLMENTS;
